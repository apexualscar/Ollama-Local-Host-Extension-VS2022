...
{
    /// <summary>
    /// Command to find issues in selected code using Ollama
    /// </summary>
    [Command(PackageIds.FindIssuesCommand)]
    internal sealed class FindIssuesCommand : BaseCommand<FindIssuesCommand>
    {
        protected override async Task ExecuteAsync(OleMenuCmdEventArgs e)
        {
            ...
            try
            {
                ...
                if (window != null)
                {
                    ...
                    if (control != null)
                    {
                        await control.FindIssuesAsync(selectedText, language);
                    }
                }
            }
            catch (Exception ex)
            {
                await VS.MessageBox.ShowErrorAsync(
                    ...
                    $"Failed to find issues: {ex.Message}"
                );
            }
        }
